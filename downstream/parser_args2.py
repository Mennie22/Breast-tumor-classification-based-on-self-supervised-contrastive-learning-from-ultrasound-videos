...
parser.add_argument('--load_type', type=str,default='t', help='load_statedict_type')
...
# Data specifications
parser.add_argument('--train_dir', type=str, default='../data/train/syu_data', help='syu train dataset directory')
parser.add_argument('--text_dir', type=str, default='../data/eval/syu_data', help='syu test dataset directory')
parser.add_argument('--train_label', type=str, default='../data/images/syu_train.csv', help='syu_train.csv')
parser.add_argument('--test_label', type=str, default='../data/images/syu_eval.csv', help='syu_test.csv')
parser.add_argument('--syu_xls', type=str, default='../data/images/syu.xls', help='syu.xls')
...
parser.add_argument('--save_loss_xlsx', type= str,default='./save_loss.xlsx', help='save loss')
...
parser.add_argument('--indices', type=int, default=400)
